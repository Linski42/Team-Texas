...
public class Dijkstra20 implements Dijkstra {
    ...
    public Direction getBestDirection(MapLocation target, Direction blockedDirection) throws GameActionException {
        ...
        if (blockedDirection != Direction.WEST && rc.canMove(Direction.WEST) && rc.sensePassability(myLocation.add(Direction.WEST))) {
            distance1 = 1.0;
            direction1 = Direction.WEST;
        }
        if (blockedDirection != Direction.EAST && rc.canMove(Direction.EAST) && rc.sensePassability(myLocation.add(Direction.EAST))) {
            distance2 = 1.0;
            direction2 = Direction.EAST;
        }
        if (blockedDirection != Direction.SOUTH && rc.canMove(Direction.SOUTH) && rc.sensePassability(myLocation.add(Direction.SOUTH))) {
            distance3 = 1.0;
            direction3 = Direction.SOUTH;
        }
        if (blockedDirection != Direction.NORTH && rc.canMove(Direction.NORTH) && rc.sensePassability(myLocation.add(Direction.NORTH))) {
            distance4 = 1.0;
            direction4 = Direction.NORTH;
        }
        if (blockedDirection != Direction.SOUTHWEST && rc.canMove(Direction.SOUTHWEST) && rc.sensePassability(myLocation.add(Direction.SOUTHWEST))) {
            distance5 = 1.0;
            direction5 = Direction.SOUTHWEST;
        }
        if (blockedDirection != Direction.NORTHWEST && rc.canMove(Direction.NORTHWEST) && rc.sensePassability(myLocation.add(Direction.NORTHWEST))) {
            distance6 = 1.0;
            direction6 = Direction.NORTHWEST;
        }
        if (blockedDirection != Direction.SOUTHEAST && rc.canMove(Direction.SOUTHEAST) && rc.sensePassability(myLocation.add(Direction.SOUTHEAST))) {
            distance7 = 1.0;
            direction7 = Direction.SOUTHEAST;
        }
        if (blockedDirection != Direction.NORTHEAST && rc.canMove(Direction.NORTHEAST) && rc.sensePassability(myLocation.add(Direction.NORTHEAST))) {
            distance8 = 1.0;
